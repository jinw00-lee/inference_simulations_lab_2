...
To do: Run these code blocks Do you understand what each line is doing here? Sim = the simulated experiment number (arbitrary number from 1-1000)
...
Taking the high_n experiment for now
...
To do: Comment what the lines of code are doing First for low-n experiments
